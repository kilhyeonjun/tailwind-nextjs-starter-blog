...
tags: ['hadoop']
draft: false
summary: hadoop 환경을 구축하기 위한 VirtualBox와 Ubuntu 설치
---
...
![img](/static/images/hadoop/vbdown.PNG)
...
![img](/static/images/hadoop/memory.PNG)
...
![img](/static/images/hadoop/ubuntudown.png)
...
- 64-bit PC (AMD64) desktop image 클릭하여 이미지 다운  
  ![img](/static/images/hadoop/disk.png)
...
- 사용자 입력
- 설치가 완료되면 다시시작  
  ![img](/static/images/hadoop/net.png)
