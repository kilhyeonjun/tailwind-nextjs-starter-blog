...
tags: ['aws']
draft: false
summary: AWS Serverless 서비스를 이해하고, AWS Lambda, CloudFront, Lambda@Edge에 대해 알아보자.
---
...
![](/static/images/ssa/ssa_serverless_in_aws.png)
...
![](/static/images/ssa/ssa_cloudfront_functions.png)
...
![](/static/images/ssa/ssa_lambda_at_edge.png)
...
![](/static/images/ssa/ssa_cloudfront_functions_vs_lambda_at_edge.png)
...
![](/static/images/ssa/ssa_default_lambda_dev.png)
...
![](/static/images/ssa/ssa_lambda_in_vpc.png)
...
![](https://velog.velcdn.com//static/images/ssa/gagaeun/post/ed40ec70-49be-4be8-8859-f7a5fc7c5f55/image.png)
...
![](/static/images/ssa/ssa_invoke_lambda_in_rds.png)
...
![](/static/images/ssa/ssa_rds_event_noti.png)
